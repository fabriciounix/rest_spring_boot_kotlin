package br.com.fabriciounix.integrationtest.controller.cors.withjson
...
import br.com.fabriciounix.integrationtest.vo.PersonVO
		...
		fun testCreate() {
			...
			specification = RequestSpecBuilder()
				.addHeader(
					...
					TestConfigs.ORIGIN_FABRICIOUNIX
				)
